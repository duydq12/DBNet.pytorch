...
class MakeBorderMap:
    ...
    def extend_line(self, point_1, point_2, result):
        ...
        cv2.line(result, tuple(ex_point_1), tuple(point_1), 4096.0, 1, lineType=cv2.LINE_AA,
                 shift=0)
        ...
        cv2.line(result, tuple(ex_point_2), tuple(point_2), 4096.0, 1, lineType=cv2.LINE_AA,
                 shift=0)
